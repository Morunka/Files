    ...
    class YaGamesSDKExtension {
        ...
        return {
          ...
          blocks: [
            ...
            },
            {
              opcode: "loadID",
              blockType: Scratch.BlockType.REPORTER,
              text: "Загрузить лидерборд с именем [NAME]",
              arguments: {
                NAME: {
      ...
      async loadID(args) {
       await ysdk.getLeaderboards()
        .then(lb => lb.getLeaderboardPlayerEntry(args.NAME))
        .then(res => {return res;})
        .catch(err => {
